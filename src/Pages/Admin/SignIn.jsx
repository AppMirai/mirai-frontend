...
const SignIn = () => {
  ...
  const handleClick = () => {
    // LOGIN TANPA API
    /* if (user.email === "admin" && user.password === "adminA1") {
    ...
    axios
      .post(`http://20.89.56.97:5000/api/users/login`, requestBody)
      .then((res) => {
  ...
  return (
    <div className="signin">
      <div
        className={`grid grid-cols-2 h-screen w-full`}
        style={{
      ...
      >
        ...
        <div className="flex items-center">
          <form
            className="max-w-[400px] w-full mx-auto bg-[#f8fafc] p-8 px-8 rounded-lg"
          ...
          >
            ...
            <button
              onClick={handleClick}
              className="w-full my-5 py-2 bg-[#E66099] text-white rounded-lg"
            >
              Sign In
            </button>
          </form>
